		...
		*/
		public function export(){
			...
			$excel->getProperties()->setCreator('Jaka Pratama, Romadan Saputra, Fajar Cahyo')
								   ...
								   ->setTitle("Data Kas Kecil")
								   ->setSubject("Kas Kecil")
								   ->setDescription("Laporan Semua Data Kas Kecil")
								   ->setKeywords("Data Kas Kecil");
			...
			$excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA KAS KECIl"); // Set kolom A1 dengan tulisan "DATA SISWA"
			...
			$sql = $pdo->prepare("SELECT * FROM kas_kecil");
			...
			$excel->getActiveSheet(0)->setTitle("Laporan Data Kas Kecil");
			$excel->setActiveSheetIndex(0);

			// Proses file excel
			header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
			header('Content-Disposition: attachment; filename="Data Kas Kecil.xlsx"'); // Set nama file excel nya
