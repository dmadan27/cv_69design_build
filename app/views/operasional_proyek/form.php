                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group field-id_proyek has-feedback">
                                    ...
                                    <select class="form-control select2" name="id_proyek" id="id_proyek" style="width: 100%"></select>
                                ...
                                <div class="form-group field-nama has-feedback">
                                    ...
                                    <input placeholder="Masukan Nama Operasional Proyek" type="text" class="form-control field" id="nama" name="nama">
                                ...
                                <div class="form-group field-id_distributor has-feedback">
                                    ...
                                    <select class="form-control select2" name="id_distributor" id="id_distributor" style="width: 100%"></select>
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12">
                                ...
                                <div class="form-group field-jenis has-feedback">
                                    ...
                                    <select name="jenis" class="form-control field select2" id="jenis" style="width: 100%"></select>
                                ...
                                <div class="form-group field-status has-feedback">
                                    ...
                                    <select name="status" class="form-control field select2" id="status" style="width: 100%"></select>
                                ...
                                <div class="form-group field-status_lunas has-feedback">
                                    ...
                                    <select name="status_lunas" class="form-control field select2" id="status_lunas" style="width: 100%"></select>
                                ...
                                <div class="form-group field-id_bank_form has-feedback">
                                    ...
                                    <select name="id_bank_form" class="form-control field select2" id="id_bank_form" style="width: 100%"></select>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <button class="btn btn-default btn-flat btn-lg" type="button" onclick="goBack()">Kembali</button>
                                </div>
                                <div class="col-md-6 col-xs-12">
